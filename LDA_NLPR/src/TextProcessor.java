	...
	// tag all name entities
		...
		public void extractDependencyContexts(File file) {
		    ...
		    Tree parse = lp.apply(sentence);
		      ...
		      Hashtable<String, String> replaceWith = new Hashtable<>();
		      String dependencyContext = tdl.toString();
